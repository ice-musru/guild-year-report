...
<template>
  <div class="swiper-5 h-full relative">
    ...
    <!--  起航  -->
    <div class="start-sail absolute bottom-0 right-0 ani" swiper-animate-effect="animate__slideInRight" swiper-animate-duration="0.5s" swiper-animate-delay="0.3s"></div>
  </div>
</template>
