...
//版本1.03
function swiperAnimateCache(a: any) {
...
function clearSwiperAnimate(a: any) {
  let effect = null;
  for (let j = 0; j < a.slides.length; j++)
    for (let allBoxes = a.slides[j].querySelectorAll(".ani"), i = 0; i < allBoxes.length; i++)
...
export { swiperAnimateCache, swiperAnimate, clearSwiperAnimate };
